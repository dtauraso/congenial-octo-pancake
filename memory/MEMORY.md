...
- [feedback_substrate_visual_pacer.md](feedback_substrate_visual_pacer.md) — Substrate node loops must not self-ack synchronously; the visual layer paces the cycle. Empty canvas + setTimeouts not firing = microtask hot loop in substrate.

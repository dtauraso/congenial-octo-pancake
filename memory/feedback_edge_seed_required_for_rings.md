...
description: Ring topologies need an initialSlots prime on the feedback input port to break startup deadlock; the loader fills the channel once before goroutines start.
metadata:
  node_type: memory
  type: feedback

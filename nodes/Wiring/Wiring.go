...
func Wire() []S.Node {
	...
	readGate1 := RGN.ReadGateNode{Id: 0, Name: "readGate1", FromValue: inputToReadGate, FromAck: i1ToReadGate, ToLatch: readGateToI0}
	i0 := CI.ChainInhibitorNode{Id: 0, Name: "i0", FromPrev: readGateToI0, ToAck: i0Ack, ToEdge: []chan<- int{i0InhibitToRight0Left}, ToNext: i0ToI1}

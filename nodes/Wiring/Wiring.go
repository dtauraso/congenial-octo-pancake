...
func Wire() []S.Node {
	...
	i0 := CI.ChainInhibitorNode{Id: 0, Name: "i0", FromPrev: readGateToI0, ToAck: i0Ack, ToEdge: []chan<- int{i0ToInhibitRight}, ToNext: i0ToI1}
	...
	return []S.Node{&in08, &readGate1, &i0, &i1, &inhibitRight0}
}
